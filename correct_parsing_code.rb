...
# hash
grouped_rows.map do |key, value|
 hash[key] = value.map {|row| [row.fetch(:score), row.fetch(:data)]}.to_h
end
...
# ~>
# ~> /var/folders/4n/wfl162xx1kl6wzbh_y83mbcr0000gn/T/seeing_is_believing_temp_dir20150919-36907-1vt073u/program.rb:46:in `<main>'
