...
class EconomicProfileTest < Minitest::Test
  ...
  def test_free_or_reduced_lunch_in_year
    ...
    assert_equal nil, academy_20.economic_profile.free_or_reduced_lunch_in_year(2_234_012)
  end
  ...
  def test_school_aged_children_in_poverty_in_year
    ...
    assert_equal nil, academy_20.economic_profile.school_aged_children_in_poverty_in_year(72_698)
  end
  ...
  def test_title_1_students_in_year
    ...
    assert_equal nil, academy_20.economic_profile.title_1_students_in_year(20_685_713)
  end
end
